    ...
    <div className="rounded-lg border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            {nurseData.map((nurse, key) => (
              <tr key={key}>
                <td className="border-b border-[#eee] py-3 dark:border-strokedark xl:pl-11">
                  <Image
                    src={nurse.avatar}
                    alt="Brand"
                    width={48}
                ...
                <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                  <p className="text-black dark:text-white">{nurse.hospital}</p>
                </td>
                <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                ...
                <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                  <p className="text-black dark:text-white">{nurse.email}</p>
                </td>
                <td className="border-b border-[#eee] py-3 px-4 dark:border-strokedark">
                  <p
