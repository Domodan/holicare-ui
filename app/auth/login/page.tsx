...
export const metadata: Metadata = {
  title: "Login | Healthcare Diagnostics Tool",
  description: "This is Login page for Healthcare Diagnostics Tool",
  // other metadata
};
            ...
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                ...
                <Image
                  ...
                  src={"/images/logo/holicare-black.svg"}
                  alt="HoliCare-Logo"
                  width={176}
                  height={32}
                />
              ...
              <p className="2xl:px-20">
                Healthcare Diagnostics Tool you can Trust
              </p>
